...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-lk-primary/30 p-2 md:p-6 bg-gradient-to-br from-lk-primary/10 to-lk-accent/10 rounded-[30px] shadow-2xl backdrop-blur-sm"
    >
